...
export async function getOrCreateAuthenticatedCustomer(email) {
...
async function newAuthenticatedCustomer(email) {
    ...
    try {
        ...
        const stripeCustomer = await stripe.customers.create({ email, preferred_locales: ["en"], metadata: { customerId } });
